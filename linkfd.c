...
static inline int lfd_run_down(int len, char *in, char **out)	//oleg
{
...
static  int lfd_run_up(int len, char *in, char **out)		//oleg
{
     register struct lfd_mod *mod;
...
static inline int lfd_check_down(void)		//oleg
{
     register struct lfd_mod *mod;
     int err = 1;
...
static inline int lfd_check_up(void)		//oleg
{
     register struct lfd_mod *mod;
     int err = 1;
